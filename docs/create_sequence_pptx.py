...
def main():
    ...
    notes_slide.notes_text_frame.text = (
        ...
        "capped at 100. This is the BEFORE score the demo starts at (typically HIGH, 50–70).\n\n"
        ...
        "sub-agents the LLM picks. Without this stage the chaos score drop would not be reliable.\n\n"
        ...
        "Unassign, SetBody — plus the legacy SetUpdatedAt record, retained on the sealed interface "
        "for backward compatibility but no longer emitted by any code path). Every agent has a "
        ...
        "the AFTER score (typically MODERATE in the demo — the real after-hours penalty is "
        "preserved by design). A Friday deploy score assesses release readiness "
